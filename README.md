...
```sh
# Using npm
npm install --save count-words

# Using yarn
yarn add count-words
```
...
If you are using this library in one of your projects, add it in this list. :sparkles:
 ...
 - `@shayan2601/new-description`
 - `@shayan2601/new-descriptionn`
 - `@shayan2601/new-package`
 - `@shayan2601/transcript`
 - `@shayan2601/transcript-package`
 - `@shayan2601/transcriptpackage`
 - `@shayan2601/transcriptss`
 - `count-words-array`
 - `leo-vue`
 - `shayan37`
 - `shayan38`
